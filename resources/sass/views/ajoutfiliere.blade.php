...
<a class="btn btn-success btn-outline-success" href="{{ route('logout') }}"  onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
  ...
  <div class="content-wrapper">
      <section class="content-header">
          <h1>
              {{$FIL==null?"AJOUT D'UNE FILIERE":"MODIFICATION DE LA FILIERE ".$FIL->name}}
            <small></small>
          </h1>

        </section>
      <form role="form" method="POST" action="{{ $FIL==null?route('filieres.store'):route('filieres.update',$FIL)}}" enctype="multipart/form-data">
            @if($FIL!=null) @method('PATCH') @endif
            ...
            <div class="box-body">
                ...
                <div class="form-group" >
                    ...
                    <input type="text" name="name" class="form-control  @error('name') is-invalid @enderror" id="adminnom" placeholder="Entrer un nom" value="{{ $FIL==null?old('name'):$FIL->name }}"  autocomplete="name" autofocus requiredautofocus>
                ...
                <div class="form-group" >
                    ...
                    <textarea name="description" class="form-control  @error('description') is-invalid @enderror" id="desc" placeholder="Entrer une description" value="{{ $FIL==null?old('description'):$FIL->description }}"  autocomplete="description" autofocus>{{ $FIL==null?old('description'):$FIL->description }}</textarea>
              ...
              <button type="submit" class="btn btn-primary">{{$FIL==null?"AJOUTER":"MODIFIER"}}</button>
                </div>
            </div>
          </form>
