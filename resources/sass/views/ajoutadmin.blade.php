          ...
          <form method="POST" action="{{ $ADMIN==null?route('admin.store'):route('admin.update',$ADMIN)}}" enctype="multipart/form-data">
            ...
            <div class="box-body">
                ...
                <div class="form-group" >
                    ...
                    <input type="text" name="name" class="form-control  @error('name') is-invalid @enderror" id="adminnom" placeholder="Entrer un nom" value="{{ $ADMIN==null?old('name'):$ADMIN->name }}"  autocomplete="name" autofocus requiredautofocus>
