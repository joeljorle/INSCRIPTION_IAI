...
<head>
 ...
 <title>{{ config('app.name', 'INSCRIPTION_IAI') }}</title>
  ...
  <!-- WARNING: Respond.js doesn't work if you view the page via CLASSESe:// -->
  <!--[if lt IE 9]>
 ...
 <li><a href="{{route('etudiants.index')}}"><i class="fa fa-users"></i>etudiants</a></li>
          ...
          <li class="active treeview menu-open">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="{{route('unitepaiements.index')}}"><i class="fa fa-square-o"></i>Unite de paiements</a></li>
  ...
  <div class="content-wrapper">
      <section class="content-header">
          <h1>
         {{$ETUD==null?"AJOUT D'ETUDIANT":"MODIFICATION DE L'ETUDIANT ".$ETUD->name.'  '.$ETUD->surname}}
            <small></small>
          </h1>
          ...
          <form method="POST" action="{{ $ETUD==null?route('etudiants.store'):route('etudiants.update',$ETUD)}}" enctype="multipart/form-data">

              @if($ETUD!=null) @method('PATCH') @endif
            ...
            <div class="box-body">
                ...
                <div class="form-group" >
                    ...
                    <input type="text" name="name" class="form-control  @error('name') is-invalid @enderror" id="adminnom" placeholder="Entrer un nom" value="{{ $ETUD==null?old('name'):$ETUD->name }}"  autocomplete="name" autofocus requiredautofocus>
                ...
                <div class="form-group" >
                    ...
                    <input type="text" name="surname" class="form-control  @error('surname') is-invalid @enderror" id="adminprenom" placeholder="Entrer un prenom" value="{{$ETUD==null? old('surname'):$ETUD->surname }}"  autocomplete="surname" autofocus>
                ...
                <div class="form-group" >
                    ...
                    <input type="number" name="phone" class="form-control  @error('phone') is-invalid @enderror" id="adminphone" placeholder="Entrer un contact" value="{{$ETUD==null? old('surname'):$ETUD->phone }}"  autocomplete="phone" autofocus>
                ...
                <div class="form-group" >
                    <label for="admininom">residence</label>
                    <input type="text" name="residence" class="form-control  @error('residence') is-invalid @enderror" id="adminnom" placeholder="Entrer le lieu de residence" value="{{ $ETUD==null?old('residence'):$ETUD->residence }}"  autocomplete="name" autofocus requiredautofocus>
                ...
                @if(count($CLASS)!=0)
                    <div class="form-group">
                        <label for="Inputclass"> sa classe</label>
                ...
                @else
                    <span class="label label-danger">Il n'ya pas de classes///</span>
                @endif
              ...
              <div class="form-group">
                <label for="email">Addresse Email</label>
                  ...
                  <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email"  placeholder="Entrer votre adresse email" value="{{$ETUD==null?old('email'):$ETUD->email}}"  autocomplete="email">
              ...
              <div class="form-group">
                <label for="exampleInputCLASSESe">choisir un image de profil</label>
                <input type="file" id="exampleInputCLASSESe" name="image">
                  @error('image')
                  <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
            ...
            <div class="box-footer">
              <button type="submit" class="btn btn-primary">{{$ETUD==null?"CREER":"MODIFIER"}}</button>
            </div>
            @endif
