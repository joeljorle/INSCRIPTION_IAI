 ...
 <li><a href="{{route('etudiants.index')}}"><i class="fa fa-users"></i>etudiants</a></li>
  ...
  <div class="content-wrapper">
      <section class="content-header">
          <h1>
              {{$CLAS==null?"AJOUT D'UNE CLASSE":"MODIFICATION DE LA CLASSE ".$CLAS->name}}
            <small></small>
          </h1>

        </section>
      <form role="form" method="POST" action="{{ $CLAS==null?route('classes.store'):route('classes.update',$CLAS)}}" enctype="multipart/form-data">
            @if($CLAS!=null) @method('PATCH') @endif
            ...
            <div class="box-body">
                ...
                <div class="form-group" >
                    ...
                    <input type="text" name="name" class="form-control  @error('name') is-invalid @enderror" id="adminnom" placeholder="Entrer un nom" value="{{ $CLAS==null?old('name'):$CLAS->name }}"  autocomplete="name" autofocus requiredautofocus>
                ...
                <div class="form-group" >
                    ...
                    <textarea name="description" class="form-control  @error('description') is-invalid @enderror" id="desc" placeholder="Entrer une description" value="{{ $CLAS==null?old('description'):$CLAS->description }}"  autocomplete="description" autofocus>{{ $CLAS==null?old('description'):$CLAS->description }}</textarea>
              ...
              <button type="submit" class="btn btn-primary">{{$CLAS==null?"AJOUTER":"MODIFIER"}}</button>
                </div>
                    @endif
            </div>
          </form>
