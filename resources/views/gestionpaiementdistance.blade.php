...
<head>
  ...
  <!-- PDISTES DE PAIEMENTLTE Skins. Choose a skin from the css/skins
...
<a class="btn btn-success btn-outline-success" href="{{ route('logout') }}"  onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
  ...
  <div class="content-wrapper">
      <section class="content-header">
          <h1>
  GESTION DES PAIEMENTS A DISTANCE
          </h1>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                  ...
                  <div class="info-box-content">
                    ...
                    <span class="info-box-number">{{count($PDISTS)}}</span>
                  </div>
                  <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">liste des paiements a distance</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              @if($PDISTS!=null)
                ...
                <td>{{$PDIST->name}}</td>
                    ...
                    <td>{{$PDIST->VERSEMENT()}}</td>

                                 <td style="display: inline-flex;flex-direction: row;">
                        <a href="{{route('paiementdistances.edit',$PDIST)}}"><span class="label label-primary" ><i class="fa fa-pencil"></i></span></a>

                        <form action="{{route('paiementdistances.destroy',[$PDIST])}}"  method="post" onclick="submit();">
                            @csrf
                            @method('DELETE')
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-success">
               <div class="inner">
                  <a  href="{{ route('paiementdistances.create') }}"> <p class="label label-primary">ajouter un paiement a distance</p></a>
              </div>
              <div class="icon">
...
<!-- PDISTES DE PAIEMENTLTE App -->
<script src="{{ asset('/public/dist/js/PDISTES DE PAIEMENTlte.min.js') }}"></script>
<!-- PDISTES DE PAIEMENTLTE dashboard demo (This is only for demo purposes) -->
<script src="{{ asset('/public/dist/js/pages/dashboard.js') }}"></script>
<!-- ChartJS -->
<script src="{{ asset('/public/bower_components/chart.js/Chart.js') }}"></script>
<!-- PDISTES DE PAIEMENTLTE for demo purposes -->
