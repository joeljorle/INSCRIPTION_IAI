  ...
  GESTION DES MODEL DE PAIEMENT
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                  ...
                  <div class="info-box-content">
                    ...
                    <span class="info-box-number">{{count($MODELS)}}</span>
                  </div>
                  <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">liste des models de paiement</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              @if($MODELS!=null)
                ...
                <td>{{$MODEL->slug}}</td>
                <td>{{$MODEL->name}}</td>
                    <td>{{$MODEL->FILIERE()->name}}</td>
                    <td>{{$MODEL->UNITE()->name}}</td>
                    <td>{{$MODEL->description}}</td>
                    <td>{{$MODEL->montant}}</td>
                    <td>{{$MODEL->delais}}</td>

                                 <td style="display: inline-flex;flex-direction: row;">
                        <a href="{{route('modelpaiements.edit',$MODEL)}}"><span class="label label-primary" ><i class="fa fa-pencil"></i></span></a>

                        <form action="{{route('modelpaiements.destroy',[$MODEL])}}"  method="post" onclick="submit();">
                            @csrf
                            @method('DELETE')
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-success">
               <div class="inner">
                  <a  href="{{ route('modelpaiements.create') }}"> <p class="label label-primary">ajouter une model</p></a>
              </div>
              <div class="icon">
...
<!-- modelS DE PAIEMENTLTE App -->
<script src="{{ asset('/public/dist/js/modelS DE PAIEMENTlte.min.js') }}"></script>
<!-- modelS DE PAIEMENTLTE dashboard demo (This is only for demo purposes) -->
<script src="{{ asset('/public/dist/js/pages/dashboard.js') }}"></script>
<!-- ChartJS -->
<script src="{{ asset('/public/bower_components/chart.js/Chart.js') }}"></script>
<!-- modelS DE PAIEMENTLTE for demo purposes -->
