...
<a class="btn btn-success btn-outline-success" href="{{ route('logout') }}"  onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
  ...
  <div class="content-wrapper">
      ...
      <section class="content-header">
          ...
          <h1>
             FILIERE DE {{$FIL->name}}  </h1>
          <p>{{$FIL->description}}</p>
          </div>
          <div class="col col-lg-4 pull-right">
              <div class="box">
                  <a href="{{route('filieres.edit',[$FIL])}}" class="btn btn-primary btn-block"><i class="fa fa-pencil"></i> <b>Modifier ce profil</b></a>
                  ...
                  <form action="{{route('filieres.destroy',[$FIL])}}" method="post" id="delete-form">
                      @csrf
                      @method('DELETE')
                  </form>
              </div>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                  ...
                  <div class="info-box-content">
                    ...
                    <span class="info-box-number">{{$FIL->EFFECTIF()}}</span>
                  </div>
                  <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                  ...
                  <div class="info-box-content">
                    ...
                    <span class="info-box-number">{{$FIL->SOLVABLE_NUMBER()}}</span>
                  </div>
                  <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
              ...
              <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                  ...
                  <div class="info-box-content">
                    ...
                    <span class="info-box-number">{{$FIL->INSOLVABLE_NUMBER()}}</span>
                  </div>
                  <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
              ...
              <!-- /.col -->
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                  <div class="info-box">
                    ...
                    <div class="info-box-content">
                      <span class="info-box-text">moratoire</span>
                      <span class="info-box-number">{{$FIL->MORATOIRE_NUMBER()}}</span>
                    </div>
                    <!-- /.info-box-content -->
                  </div>
                  <!-- /.info-box -->
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box">
                      ...
                      <div class="info-box-content">
                        <span class="info-box-text">Versement (FCFA)</span>
                        <span class="info-box-number">{{$FIL->VERSEMENT()}}</span>
                      </div>
                      <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                  ...
                  <!-- /.col -->
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12">
                      <div class="info-box">
                        ...
                        <div class="info-box-content">
                          <span class="info-box-text">Penalite (FCFA)</span>
                          <span class="info-box-number">{{$FIL->PENALITE_NUMBER()}}</span>
                        </div>
                        <!-- /.info-box-content -->
                      </div>
                      <!-- /.info-box -->
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="info-box">
                          ...
                          <div class="info-box-content">
                            <span class="info-box-text"> PENSION TOTAL </span>
                            <span class="info-box-number">{{$FIL->PENSION_TOTAL()}}</span>
                          </div>
                          <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
                      ...
                      <!-- /.col -->
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                          <div class="info-box">
                            <span class="info-box-icon bg-primary"><i class="fa fa-square-o"></i></span>

                            <div class="info-box-content">
                              <span class="info-box-text">Montant moratoire</span>
                              <span class="info-box-number">{{$FIL->MORATOIRE_NUMBER()}}(FCFA)</span>
                            </div>
                            <!-- /.info-box-content -->
                          </div>
                          <!-- /.info-box -->
        ...
        <div class="box">
            <div class="box-header">
              <h3 class="box-title">classes insolvables</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example2" class="table table-bordered table-striped">
                ...
                <tbody>
                @if($FIL->INSOLVABLE_CLASSE()!=null)
                    @foreach($FIL->INSOLVABLE_CLASSE() as $CLASS)
                <tr>
                  <td>{{$CLASS->slug}}</td>
                  <td>{{$CLASS->name}}</td>
                  <td>{{$CLASS->VERSEMENT_NUMBER()}}</td>
                  <td>{{$CLASS->VERSEMENT_RESTE_NUMBER()}}</td>
                  <td>{{$CLASS->PENALITE_NUMBER()}}</td>
                    <td style="display: inline-flex;flex-direction: row;">
                        <a href="{{route('classes.edit',$CLASS)}}"><span class="label label-primary" ><i class="fa fa-pencil"></i></span></a>

                        <form action="{{route('classes.destroy',[$CLASS])}}"  method="post" onclick="submit();">
                            @csrf
                            @method('DELETE')
                        ...
                        <a href="{{route('classes.show',$CLASS)}}"><span class="label label-primary"><i class="fa fa-eye"></i></span></a>
                    </td>
                </tr>
                @endforeach
                @endif
      ...
      <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-success">
              <div class="inner">
                  <a  href="{{ route('filieres.create') }}"> <p class="label label-primary">nouvelle une filiere</p></a>
              </div>
              <div class="icon">
