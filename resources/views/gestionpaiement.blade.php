...
<a class="btn btn-success btn-outline-success" href="{{ route('logout') }}"  onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
  ...
  <div class="content-wrapper">
      ...
      <section class="content-header">
          ...
          <h1>
           <i class="fa fa-money"></i> PAIEMENTS </h1>
          </div>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                  ...
                  <div class="info-box-content">
                    <span class="info-box-text">NBRE PAIEMENTS</span>
                    <span class="info-box-number">{{count($PAIES)}}</span>
                  </div>
                  <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                  ...
                  <div class="info-box-content">
                    ...
                    <span class="info-box-number">{{$MONTANT}}</span>
                  </div>
                  <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
        ...
        <div class="box">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-striped">
                ...
                <tr>
                  <td>{{$PAIE->slug}}</td>
                  <td>{{$PAIE->ETUDIANT()->name.' '.$PAIE->ETUDIANT()->surname}}</td>
                  <td>{{$PAIE->montant}}</td>
                  <td>{{$PAIE->ETUDIANT()->VERSEMENT_RESTE()}}</td>
                  <td>{{$PAIE->created_at}}</td>

                    <td style="display: inline-flex;flex-direction: row;">

                        <form action="{{route('paiements.destroy',[$PAIE])}}"  method="post" onclick="submit();">
                            @csrf
                            @method('DELETE')
                            <a href="#"><span class="label label-primary"><i class="fa fa-trash"></i></span></a>
                        </form>
                        <a href="{{route('paiements.show',$PAIE)}}"><span class="label label-primary"><i class="fa fa-eye"></i></span></a>
                    </td>
                </tr>
                @endforeach
                @endif
      ...
      <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-dark">
              <div class="inner">
                  <a  href="{{ route('paiements.create') }}"> <p class="label label-primary">nouveau paiement</p></a>
              </div>
              <div class="icon">
