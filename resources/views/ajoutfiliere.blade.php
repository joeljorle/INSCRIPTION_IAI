      ...
      <form role="form" method="POST" action="{{ $FIL==null?route('filieres.store'):route('filieres.update',$FIL)}}" enctype="multipart/form-data">
            ...
            <div class="box-body">
                ...
                <div class="form-group" >
                    ...
                    <input type="text" name="name" class="form-control  @error('name') is-invalid @enderror" id="adminnom" placeholder="Entrer un nom" value="{{ $FIL==null?old('name'):$FIL->name }}"  autocomplete="name" autofocus required>
