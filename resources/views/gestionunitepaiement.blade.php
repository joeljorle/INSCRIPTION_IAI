...
<head>
  ...
  <!-- UNITES DE PAIEMENTLTE Skins. Choose a skin from the css/skins
  ...
  GESTION DES UNITES DE PAIEMENT
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                  ...
                  <div class="info-box-content">
                    ...
                    <span class="info-box-number">{{count($UNITS)}}</span>
                  </div>
                  <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">liste des unites de paiement</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              @if($UNITS!=null)
                ...
                <td>{{$UNIT->name}}</td>
                    ...
                    <td>{{$UNIT->VERSEMENT()}}</td>

                                 <td style="display: inline-flex;flex-direction: row;">
                        <a href="{{route('unitepaiements.edit',$UNIT)}}"><span class="label label-primary" ><i class="fa fa-pencil"></i></span></a>

                        <form action="{{route('unitepaiements.destroy',[$UNIT])}}"  method="post" onclick="submit();">
                            @csrf
                            @method('DELETE')
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-success">
               <div class="inner">
                  <a  href="{{ route('unitepaiements.create') }}"> <p class="label label-primary">ajouter une unite</p></a>
              </div>
              <div class="icon">
...
<!-- UNITES DE PAIEMENTLTE App -->
<script src="{{ asset('/public/dist/js/UNITES DE PAIEMENTlte.min.js') }}"></script>
<!-- UNITES DE PAIEMENTLTE dashboard demo (This is only for demo purposes) -->
<script src="{{ asset('/public/dist/js/pages/dashboard.js') }}"></script>
<!-- ChartJS -->
<script src="{{ asset('/public/bower_components/chart.js/Chart.js') }}"></script>
<!-- UNITES DE PAIEMENTLTE for demo purposes -->
