  ...
  GESTION DES FILIERES
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">liste des filieres</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              @if($FILS!=null)
                ...
                <td>{{$FIL->name}}</td>
                    ...
                    <td>{{$FIL->EFFECTIF()}}</td>
                    <td>{{$FIL->PENSION_TOTAL()}}</td>
                    <td>{{$FIL->VERSEMENT()}}</td>

                                 <td style="display: inline-flex;flex-direction: row;">
                        <a href="{{route('filieres.edit',$FIL)}}"><span class="label label-primary" ><i class="fa fa-pencil"></i></span></a>

                        <form action="{{route('filieres.destroy',[$FIL])}}"  method="post" onclick="submit();">
                            @csrf
                            @method('DELETE')
                        ...
                        <a href="{{route('filieres.show',$FIL)}}"><span class="label label-primary"><i class="fa fa-eye"></i></span></a>
                    </td>
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-success">
               <div class="inner">
                  <a  href="{{ route('filieres.create') }}"> <p class="label label-primary">ajouter une filiere</p></a>
              </div>
              <div class="icon">
