...
<head>
  ...
  <!-- classesLTE Skins. Choose a skin from the css/skins
  ...
  GESTION DES CLASSES
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              @if($CLASS!=null)
                ...
                <td>{{$CLAS->name}}</td>
                    ...
                    <td>{{$CLAS->EFFECTIF()}}</td>
                    <td>{{$CLAS->VERSEMENT()}}</td>

                                 <td style="display: inline-flex;flex-direction: row;">
                        <a href="{{route('classes.edit',$CLAS)}}"><span class="label label-primary" ><i class="fa fa-pencil"></i></span></a>

                        <form action="{{route('classes.destroy',[$CLAS])}}"  method="post" onclick="submit();">
                            @csrf
                            @method('DELETE')
                        ...
                        <a href="{{route('classes.show',$CLAS)}}"><span class="label label-primary"><i class="fa fa-eye"></i></span></a>
                    </td>
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-success">
               <div class="inner">
                  <a  href="{{ route('classes.create') }}"> <p class="label label-primary">ajouter une classe</p></a>
              </div>
              <div class="icon">
...
<!-- classesLTE App -->
<script src="{{ asset('/public/dist/js/classeslte.min.js') }}"></script>
<!-- classesLTE dashboard demo (This is only for demo purposes) -->
<script src="{{ asset('/public/dist/js/pages/dashboard.js') }}"></script>
<!-- ChartJS -->
<script src="{{ asset('/public/bower_components/chart.js/Chart.js') }}"></script>
<!-- classesLTE for demo purposes -->
