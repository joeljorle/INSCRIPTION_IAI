...
<a class="btn btn-success btn-outline-success" href="{{ route('logout') }}"  onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
  ...
  <div class="content-wrapper">
      ...
      <section class="content-header">
          ...
          <h1>
            CLASSE DE {{$CLAS->name}}  </h1>
          <p>{{$CLAS->description}}</p>
          </div>
          <div class="col col-lg-4 pull-right">
              <div class="box">
                  <a href="{{route('classes.edit',[$CLAS])}}" class="btn btn-primary btn-block"><i class="fa fa-pencil"></i> <b>Modifier ce profil</b></a>
                  ...
                  <form action="{{route('classes.destroy',[$CLAS])}}" method="post" id="delete-form">
                      @csrf
                      @method('DELETE')
                  </form>
              </div>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                  ...
                  <div class="info-box-content">
                    ...
                    <span class="info-box-number">{{$CLAS->EFFECTIF()}}</span>
                  </div>
                  <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                  ...
                  <div class="info-box-content">
                    ...
                    <span class="info-box-number">{{$CLAS->SOLVABLE_NUMBER()}}</span>
                  </div>
                  <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
              ...
              <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                  ...
                  <div class="info-box-content">
                    ...
                    <span class="info-box-number">{{$CLAS->INSOLVABLE_NUMBER()}}</span>
                  </div>
                  <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                  <div class="info-box">
                    ...
                    <div class="info-box-content">
                      ...
                      <span class="info-box-number">{{$CLAS->MORATOIRE_NUMBER()}}</span>
                    </div>
                    <!-- /.info-box-content -->
                  </div>
                  <!-- /.info-box -->
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box">
                      ...
                      <div class="info-box-content">
                        ...
                        <span class="info-box-number">{{$CLAS->VERSEMENT()}}</span>
                      </div>
                      <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                  ...
                  <!-- /.col -->
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12">
                      <div class="info-box">
                        ...
                        <div class="info-box-content">
                          ...
                          <span class="info-box-number">{{$CLAS->PENALITE_NUMBER()}}</span>
                        </div>
                        <!-- /.info-box-content -->
                      </div>
                      <!-- /.info-box -->
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="info-box">
                          ...
                          <div class="info-box-content">
                            <span class="info-box-text"> Qte de Versement </span>
                            <span class="info-box-number">{{$CLAS->VERSEMENT_QTY()}}</span>
                          </div>
                          <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                          <div class="info-box">
                            ...
                            <div class="info-box-content">
                              ...
                              <span class="info-box-number">{{$CLAS->MORATOIRE_NUMBER()}}(FCFA)</span>
                            </div>
                            <!-- /.info-box-content -->
                          </div>
                          <!-- /.info-box -->
        ...
        <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                @if($CLAS->ETUDIANTS()!=null)
                    @foreach($CLAS->ETUDIANTS() as $ETUD)
                <tr>
                  <td>{{$ETUD->slug}}</td>
                  <td>{{$ETUD->name.' '.$ETUD->surname}}</td>
                  <td>{{$ETUD->STATUS()}}</td>
                    <td style="display: inline-flex;flex-direction: row;">
                        <a href="{{route('etudiants.edit',$ETUD)}}"><span class="label label-primary" ><i class="fa fa-pencil"></i></span></a>

                        <form action="{{route('etudiants.destroy',[$ETUD])}}"  method="post" onclick="submit();">
                            @csrf
                            @method('DELETE')
                        ...
                        <a href="{{route('etudiants.show',$ETUD)}}"><span class="label label-primary"><i class="fa fa-eye"></i></span></a>
                    </td>
                </tr>
                @endforeach
                @endif
        ...
        <div class="box">
          <div class="box-header">
              <h3 class="box-title">liste des insolvables</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
                  ...
                  @if($CLAS->ETUDIANTS()!=null)
                      @foreach($CLAS->ETUDIANTS() as $ETUD)
                          <tr>
                              <td>{{$ETUD->slug}}</td>
                              <td>{{$ETUD->name.' '.$ETUD->surname}}</td>
                              <td>{{$ETUD->VERSEMENT()}}</td>
                              <td>{{$ETUD->VERSEMENT_RESTE()}}</td>
                              <td>{{$ETUD->PENALITE()}}</td>
                              <td style="display: inline-flex;flex-direction: row;">
                                  <a href="{{route('etudiants.edit',$ETUD)}}"><span class="label label-primary" ><i class="fa fa-pencil"></i></span></a>
      ...
      <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-success">
              <div class="inner">
                  <a  href="{{ route('classes.create') }}"> <p class="label label-primary">nouvelle une filiere</p></a>
              </div>
              <div class="icon">
