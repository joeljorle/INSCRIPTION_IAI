          ...
          <form method="POST" action="{{ $ETUD==null?route('etudiants.store'):route('etudiants.update',$ETUD)}}" enctype="multipart/form-data">
            ...
            <div class="box-body">
                ...
                <div class="form-group" >
                    ...
                    <input type="text" name="name" class="form-control  @error('name') is-invalid @enderror" id="adminnom" placeholder="Entrer un nom" value="{{ $ETUD==null?old('name'):$ETUD->name }}"  autocomplete="name" autofocus required>
                ...
                <div class="form-group" >
                    ...
                    <input type="text" name="residence" class="form-control  @error('residence') is-invalid @enderror" id="adminnom" placeholder="Entrer le lieu de residence" value="{{ $ETUD==null?old('residence'):$ETUD->residence }}"  autocomplete="name" autofocus required>
                ...
                @if(count($CLASS)!=0)
                    <div class="form-group">
                        ...
                        <select class="form-control" id="Inputclass" name="classe">
