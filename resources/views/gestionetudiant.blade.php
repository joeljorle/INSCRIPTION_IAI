...
<head>
  ...
  <!-- ETUDIANTSLTE Skins. Choose a skin from the css/skins
...
<a class="btn btn-success btn-outline-success" href="{{ route('logout') }}"  onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
  ...
  GESTION DES ETUDIANTS
          ...
          <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                      ...
                      <td>@if($ETUD->CLASSE()!=null){{$ETUD->CLASSE()->name}}@endif</td>
      ...
      <div class="box">
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-warning">
               <div class="inner">
                  <a  href="{{ route('etudiants.create') }}"> <p class="label label-primary">ajouter un etudiant</p></a>
              </div>
              <div class="icon">
      ...
      @if(count($CLASS)!=0)
              <div class="box">
      <form role="form" method="POST" action="{{route('etudiants.search')}}" enctype="multipart/form-data">



          <div class="form-group">
              <label for="Inputfiliere"> rechercher pour une classe</label>
              <div class="row">
              <select class="form-control pull-left col-lg-6" id="Inputfiliere" name="classe" placeholder="classe">
                  @foreach($CLASS as $CLAS)
                  <option value="{{$CLAS->id}}">{{$CLAS->name}}</option>
                  @endforeach
              </select>
              <button type="submit" class="btn btn-primary pull-right col-lg-2"><i class="fa fa-search"></i> <span>rechercher</span></button>
              </div>
          </div>
...
<!-- ETUDIANTSLTE App -->
<script src="{{ asset('/public/dist/js/ETUDIANTSlte.min.js') }}"></script>
<!-- ETUDIANTSLTE dashboard demo (This is only for demo purposes) -->
<script src="{{ asset('/public/dist/js/pages/dashboard.js') }}"></script>
<!-- ChartJS -->
<script src="{{ asset('/public/bower_components/chart.js/Chart.js') }}"></script>
<!-- ETUDIANTSLTE for demo purposes -->
