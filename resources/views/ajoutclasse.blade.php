      ...
      <form role="form" method="POST" action="{{ $CLAS==null?route('classes.store'):route('classes.update',$CLAS)}}" enctype="multipart/form-data">
            ...
            <div class="box-body">
                ...
                <div class="form-group" >
                    ...
                    <input type="text" name="name" class="form-control  @error('name') is-invalid @enderror" id="adminnom" placeholder="Entrer un nom" value="{{ $CLAS==null?old('name'):$CLAS->name }}"  autocomplete="name" autofocus required>
